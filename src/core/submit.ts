...
const TIER_FIT: Record<string, string> = { starter: "Starter", hiring: "Talent reach", education: "Education", vital: "Vital", visibility: "Visibility", story: "LinkedIn", product: "Product" };
